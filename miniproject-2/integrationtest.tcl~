...
expect "Enter number of rows: " {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
...
expect "         1   2   1" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
expect "       1   3   3   1" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
expect "     1   4   6   4   1" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
