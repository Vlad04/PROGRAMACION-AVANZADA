...
expect "Value of number: " {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
#expect "What is the id:" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
send "3\r"
expect "nth FIbonacci number: 2" {foreground green; puts "PASSED";reset} default {foreground red;puts "FAILED";reset}
